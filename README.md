...
Clone the Fangular repository using [bower][bower]:

```
bower install Fangular
cd Fangular
```
...
## Directory Layout
    ...
    app/                   --> all of the files to be used in production
      assets/              --> resources folder bundled images/css/js
        css/               --> css files
      ...
      index.html           --> app layout file (the main html template file of the app)(async)
        js/                --> javascript files
          ...
          core/            --> application controllers
            init.js        --> initiator
            app.js         --> application
            struct.js      --> controller's prototype
          directives/      --> application directives
            ver.js         --> demo view controller
          filters/         --> custom angular filters
            interpolate.js --> demo filter
          i18n/            --> language files
            en_US.js       --> demo english language
            zh_TW.js       --> demo chinese language
          modules/         --> third-party files
            head.min.js    --> lazy loader
          services/        --> custom angular services
            helper.js      --> my usual helper
